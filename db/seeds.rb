...
event_desc.each do |desc|
    params = { report: { event_desc: desc, suspect_desc: desc, comments_attributes: [comment_text: desc], location_attributes: { lat: 10, lng:10 }, images_attributes: [image_link: "https://www.imgur.com/example_link", image_checksum: "120EA8A25E5D487BF68B5F7096440019"]} }
